 ...
 * Joomla 5.x + PHP 8.1+
 *
 * Arizona Fantasy 5 (AZ2) — Analysis & Results Page
 * - game_id   = AZ2
 * - main balls = 5
 * - main range = 01..41
 * - no bonus ball
...
if (isset($stateName, $gName) && $stateName !== '' && $gName !== '') {
    ...
    $doc->setMetaData('description', 'Analyze ' . $stateName . ' ' . $gName . ' lottery results. Explore number frequency, hot and cold numbers, recency, and draw history insights powered by LottoExpert data intelligence.');
}
...
/**
 * --------------------------------------------------------------------------
 * Structured data (JSON-LD) for SEO and AIO / LLM discovery
 * --------------------------------------------------------------------------
 */
$jsonLdName        = htmlspecialchars((isset($stateName) ? (string) $stateName : '') . ' ' . (isset($gName) ? (string) $gName : '') . ' Results Analysis', ENT_QUOTES, 'UTF-8');
$jsonLdDescription = 'Historical number frequency, recency, and draw analysis for ' . (isset($stateName) ? (string) $stateName : '') . ' ' . (isset($gName) ? (string) $gName : '') . '. Explore hot and cold numbers, draw history insights, and data-driven context for informed lottery analysis.';
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "name": "<?php echo leEscapeJsString($jsonLdName); ?>",
      "description": "<?php echo leEscapeJsString($jsonLdDescription); ?>",
      "url": "<?php echo leEscapeJsString($jsonLdUrl); ?>",
      "inLanguage": "en-US",
      "publisher": {
        "@type": "Organization",
    ...
    {
      "@type": "Dataset",
      "name": "<?php echo leEscapeJsString((isset($stateName) ? (string) $stateName : '') . ' ' . (isset($gName) ? (string) $gName : '') . ' Number Frequency Data'); ?>",
      "description": "<?php echo leEscapeJsString('Frequency counts, recency distances, and draw history data for ' . (isset($stateName) ? (string) $stateName : '') . ' ' . (isset($gName) ? (string) $gName : '') . ' lottery draws. Data includes appearance counts per number across configurable historical windows.'); ?>",
      "url": "<?php echo leEscapeJsString($jsonLdUrl); ?>",
      ...
      <div class="skai-hero-top">
        ...
        <div class="skai-hero-copy">
          ...
          <div class="skai-hero-actions" aria-label="Primary actions">
            <a class="skai-btn skai-btn--primary" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=AZ2">
              Open SKAI Analysis
            </a>
            <a class="skai-btn skai-btn--secondary" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=AZ2">
              AI Predictions
            </a>
          ...
          <div class="skai-advanced-links" aria-label="Advanced tools">
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=AZ2">Skip &amp; Hit Analysis</a>
            <a class="skai-mini-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=AZ2">MCMC Markov Analysis</a>
            <a class="skai-mini-link" href="/all-lottery-heatmaps?gameId=AZ2"><?php echo htmlspecialchars((string) $gName, ENT_QUOTES, 'UTF-8'); ?> Heatmap Analysis</a>
          </div>
        </div>
    ...
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Start with a clear high-level view. This layer is designed for fast orientation: which numbers are most active, which are quiet, and how the current draw relates to recent history. Numbers 01&ndash;41 are analyzed across the selected draw window.
        </p>
      </div>
    </div>
  ...
  <section id="frequency-deep-dive" class="skai-section" aria-labelledby="frequency-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Move from summary to full reference. The panels below show the complete number distribution across all values 01&ndash;41 and the recency profile for each number within the selected analysis window. Frequency counts how often each number was drawn; recency shows how many draws ago each number last appeared.
        </p>
      </div>
    </div>
    ...
    <div class="skai-section-body">
        ...
        <div class="skai-grid">
          <div class="skai-card">
            <div class="skai-card-head skai-card-head--ember">
              ...
              <span class="skai-card-sub">Distance since last appearance for each number (draws ago)</span>
            </div>
            <div class="skai-card-body">
              <div class="skai-chart-shell">
                <div class="skai-chart-frame">
          ...
          <div class="skai-card">
            <div class="skai-card-head skai-card-head--radiant">
              Top 10 by frequency
              <span class="skai-card-sub">Most-drawn numbers in the current window</span>
            </div>
            <div class="skai-card-body">
              <div class="skai-chart-shell">
                <div class="skai-chart-frame">
                  <canvas id="topFreqChart" aria-label="Top frequency numbers chart" role="img"></canvas>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="skai-note">
        The complete distribution is best used as a reference layer. The overview modules above are optimized for quick reading; this section is optimized for thorough review. Recency values shown as the number of draws since the ball last appeared &mdash; a higher value means a longer absence.
      </div>
    </div>
  </section>
  ...
  <section id="tables" class="skai-section" aria-labelledby="tables-title">
    <div class="skai-section-head">
      <div>
        ...
        <p class="skai-section-sub">
          Use the table for exact counts, recency, and personal tracking. Quick filters help narrow the view without losing full access to the complete dataset. Each number from 01 to 41 is listed with its draw count and last-seen distance within the selected window.
        </p>
      </div>
    </div>
      ...
      <form name="fqsearch" method="post" action="/all-us-lotteries/results-analysis?st=<?php echo htmlspecialchars((string) $stateAbrev, ENT_QUOTES, 'UTF-8'); ?>&amp;stn=<?php echo htmlspecialchars((string) $stateName, ENT_QUOTES, 'UTF-8'); ?>&amp;gm=<?php echo htmlspecialchars((string) $gName, ENT_QUOTES, 'UTF-8'); ?>#tables">
        <div class="skai-controls-row">
          <div class="skai-controls-left">
            <label for="nod">Draw window (drawings to analyze)</label>
    ...
    <div class="skai-section-body">
      <div class="skai-card">
        <div class="skai-card-head skai-card-head--horizon">
          Numbers table
          <span class="skai-card-sub">Exact counts and recency for values 01&ndash;41 in the last <?php echo (int) $nodCurrentMain; ?> drawings</span>
        </div>
      ...
      <div class="skai-tool-grid">
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skai-lottery-prediction?gameId=AZ2">Open SKAI Analysis</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/ai-powered-predictions?game_id=AZ2">Open AI Predictions</a>
          </div>
        </article>
        ...
        <article class="skai-tool">
          ...
          <div class="skai-tool-body">
            ...
            <a class="skai-tool-cta" href="/picking-winning-numbers/artificial-intelligence/skip-and-hit-analysis?game_id=AZ2">Open Skip &amp; Hit</a>
          </div>
        </article>
      </div>

      <div class="skai-utility-grid">
        <a class="skai-utility-link" href="/picking-winning-numbers/artificial-intelligence/markov-chain-monte-carlo-mcmc-analysis?game_id=AZ2">MCMC Markov Analysis</a>
        <a class="skai-utility-link" href="/all-lottery-heatmaps?gameId=AZ2"><?php echo htmlspecialchars((string) $gName, ENT_QUOTES, 'UTF-8'); ?> Heatmap Analysis</a>
  ...
  <section class="skai-section" aria-labelledby="method-title">
    ...
    <div class="skai-section-body">
      <div class="skai-method-note">
        <strong>Interpretation guidance:</strong> Frequency, recency, and spacing can provide useful context for reviewing draw history, but they should be treated as descriptive signals rather than guarantees. Lottery draws are independent random events. The purpose of this page is to make the recent behavior of <?php echo htmlspecialchars((string) $stateName . ' ' . (string) $gName, ENT_QUOTES, 'UTF-8'); ?> easier to understand, compare, and carry into deeper SKAI analysis. No analysis tool can predict lottery outcomes.
      </div>
    </div>
  </section>
...
(function () {
  ...
  function renderCharts() {
    ...
    var topFreqCanvas   = safeGetCanvas('topFreqChart');
    ...
    if (topFreqCanvas) {
      new Chart(topFreqCanvas.getContext('2d'), {
        type: 'bar',
        data: {
          labels: chartData.topActiveLabels,
          datasets: [{
